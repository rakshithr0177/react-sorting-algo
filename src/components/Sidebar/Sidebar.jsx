...
import { changeValues, updateAlgorithm, updateColor, updateRange, updateSpeed } from '../../slices/updatePropsSlice';
...
function Sidebar() {
  ...
  const handleRange = (_range) => {
    ...
    dispatch(updateRange(_range))
    dispatch(changeValues())
  }

  const handleColor = (_color) => {
    dispatch(updateColor(_color))
  }

  const handleSpeed = (_speed) => {
    dispatch(updateSpeed(_speed))
  }
